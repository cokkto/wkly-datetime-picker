...
export default defineConfig({
  testDir: './projects/wkly-datetime-picker.showcase/e2e', testMatch: 'runtime-bridge.spec.ts', fullyParallel: true, timeout: 30000, expect: { timeout: 7000 }, retries: process.env.CI ? 1 : 0, workers: 2,
